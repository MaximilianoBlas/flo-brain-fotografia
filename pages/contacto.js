 ...
 function inputChange(e) {
    ...
    function validate(input) {
        ...
        if (!input.name) errors.name = "El nombre es requerido";
            ...
            errors.name = "Nombre invalido, no se permiten numeros";

        if (!input.lastname) errors.lastname = "El apellido es requerido";
        else if (/([0-9])/.test(input.lastname))
            errors.lastname = "Apellido invalido, no se permiten numeros";
        ...
        else if (!/[\w\s]{20,}/.test(input.message))
            errors.message =
                "El mensaje debe contener 20 caracteres como minimo";
    ...
    return (
        <div className={mainContainer}>
            <div>
                <form
                    action="https://formsubmit.co/5b2874ac538366ee8f8a1f48f74e64a6"
                    method="POST"
                >
