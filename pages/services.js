  ...
  const serviceArray = [
    {
      ...
      content: "Para que quede congelado para siempre el crecimiento de tu pequeño/a , guardamos gestos, instantes para siempre.",
    },
    {
      navegation: "/Comuniones.webp",
      title: "Comuniones",
      content: "El resultado de las fotografías de primera comunión será irrepetible, una sesión de fotos diferente, naturales.",
    },
    {
    ...
    },
    {
      ...
      content: "Disfruta de este momento especial y nosotros nos encargamos de todo lo demás.La temática de tu sesión la elegís vos.",
    },
    {
    ...
    <div className={mainContainer}>
      <div className={arrayContainer}>
        {serviceArray.map((e, i) => {
          return (
            <div onClick={changeSelectedService} className={cardContainer} key={i}>
              <div
              ...
              >
                ...
                <Image className={image} src={e.navegation} fill={true} alt="" />
